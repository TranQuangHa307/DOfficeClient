        ...
        <>
            <Form className="mt-4" onSubmit={onSubmit}>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" placeholder="Nơi nhận" name="receiveAddress" onChange={onChange}/>
                    {error.receiveAddress && <span style={{color: 'red'}}>{error.receiveAddress}</span>}
                </Form.Group>

                <Form.Group className="mb-3">
                    <Form.Label>Người ký</Form.Label>
                    <Form.Select name="signBy" onChange={onChange}>
...
export default AddOutGoingDispatch;