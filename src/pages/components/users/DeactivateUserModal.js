...
const DeactivateUserModal = (props) => {
	...
	const handleSubmit = (e) => {
		...
		// submit
		setSubmitting(true);
        dispatch(userActions.deActivateUser(props.userId))
            .then(() => {
				dispatch(userActions.getUserById(props.userId));
                toast.success("Deactivate tài khoản thành công", { autoClose: 3000, hideProgressBar : true });
		...
		<Modal show={props.show} onHide={handleClose}>
			<Form onSubmit={handleSubmit}>
				<Modal.Header closeButton>
					<Modal.Title>Dừng hoạt động tài khoản</Modal.Title>
				</Modal.Header>
				<Modal.Body>
					Bạn có chắn chắn bạn thực sự muốn dừng hoạt động tài khoản này?
				</Modal.Body>
				<Modal.Footer>
